...
const mockFriends = [
  { name: 'Sarah M.', avatar: 'SM', joined: 'Mar 5', status: 'active', streak: 3, xpEarned: 100 },
  { name: 'Diego R.', avatar: 'DR', joined: 'Mar 2', status: 'active', streak: 5, xpEarned: 100 },
];

const steps = [
  { icon: 'LINK', title: 'Share your link', desc: 'Send your unique invite to friends' },
  { icon: 'JOIN', title: 'Friend joins', desc: 'They create their PocketPig account' },
  { icon: 'XP', title: 'Both earn XP', desc: '+100 XP when they feed their first piggy' },
];
    ...
    <div className="flex flex-col min-h-screen px-5 pt-14 pb-6 relative overflow-hidden">
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(34,211,238,0.18), rgba(129,140,248,0.14))', border: '1px solid rgba(34,211,238,0.25)' }}
        >
          <span className="text-white" style={{ fontWeight: 800, fontSize: 18 }}>PP</span>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          {steps.map((step, i) => (
            ...
            >
              <div
                className="mb-2 mx-auto w-10 h-10 rounded-xl flex items-center justify-center"
                style={{ background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.72)', fontSize: 11, fontWeight: 800 }}
              >
                {step.icon}
              </div>
